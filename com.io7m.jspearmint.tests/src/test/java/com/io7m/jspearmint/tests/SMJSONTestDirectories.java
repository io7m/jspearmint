...
public final class SMJSONTestDirectories
{
  private static final Logger LOGGER =
    LoggerFactory.getLogger(SMJSONTestDirectories.class);

  private SMJSONTestDirectories()
  {
  ...
  {
    final var path =
      Path.of(System.getProperty("java.io.tmpdir")).resolve("jspearmint");
  ...
  public static Path resourceOf(
    ...
    throws IOException
  {
    final var internal = String.format("/com/io7m/jspearmint/tests/%s", name);
